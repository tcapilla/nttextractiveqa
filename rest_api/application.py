...
def get_application() -> FastAPI:
    application = FastAPI(title="NTT EXTRACTIVE QA", debug=True, version="0.1")
...
logger.info(
    """
Or just try it out directly: curl --request POST --url 'http://127.0.0.1:8000/models/1/doc-qa' --data '{"questions": ["What is the capital of Spain?"]}'
"""
)
